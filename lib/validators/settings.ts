...
export const settingsSchema = z.object({
  ...
  heroMainImageUrl: z.string().max(500).optional().or(z.literal("")),
  heroDetailImageUrl: z.string().max(500).optional().or(z.literal("")),
...
export function normalizeSettingsPayload(payload: Partial<Record<string, unknown>>) {
  ...
  return {
    ...
    heroMainImageUrl: String(payload.heroMainImageUrl ?? "").trim(),
    heroDetailImageUrl: String(payload.heroDetailImageUrl ?? "").trim(),
